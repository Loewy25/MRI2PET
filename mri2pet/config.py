...
CDRM_LAMBDA_C_COEF = _env_float("CDRM_LAMBDA_C_COEF", CDRM_LAMBDA_COEF)
CDRM_LAMBDA_A_COEF = _env_float("CDRM_LAMBDA_A_COEF", 2.0)
...
CDRM_A_STAGE_WEIGHT_2 = _env_float("CDRM_A_STAGE_WEIGHT_2", 2.0)
CDRM_A_STAGE_WEIGHT_3 = _env_float("CDRM_A_STAGE_WEIGHT_3", 4.0)
